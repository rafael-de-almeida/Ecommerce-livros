...
public class EcommerceTest {
    ...
    void testFazerPedidoDeTroca() throws InterruptedException {
        navigateToPage("http://127.0.0.1:5500/frontend-ecommerce-livros/historicoCompras.html?id=2");
    ...
    void testTroca() throws InterruptedException{
        ...
        navigateToPage("http://127.0.0.1:5500/frontend-ecommerce-livros/pesquisarVendas.html");
        System.out.println("[INFO] Page opened successfully.");
        ...
        select.selectByValue("TROCA AUTORIZADA");
    ...
    void compra(String cupom) throws InterruptedException{
            ...
            navigateToPage("http://127.0.0.1:5500/frontend-ecommerce-livros/TelaInicial.html?id=2");
